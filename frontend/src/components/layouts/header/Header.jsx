...
const Header = ({ search, setSearch, category, price, ratings, setPage }) => {
  ...
  const { isAuthenticated, user, logout: { isLoading: logoutLoading, isError, error, isSuccess } } = useSelector(state => state.auth);
  ...
  }, [dispatch, isAuthenticated, isSuccess, isError, history]);
                            ...
                            <Paper>
                              <ClickAwayListener onClickAway={handleClose}>
                                <MenuList autoFocusItem={open} id="menu-list-grow" onKeyDown={handleListKeyDown}>
                                  ...
                                  <MenuItem onClick={handleLogout} style={{ color: "#5C0512" }} >
                                    {logoutLoading ? <CircularProgress /> : "Logout"}
                                  </MenuItem>
                                </MenuList>
                              </ClickAwayListener>
                            </Paper>
